...
;(async () => {
  for (const url of routesToPrerender) {
    try {
      ...
      const { html: criticalHtml } = await critical.generate({
        base: toAbsolute('dist'),
        src: filePath,
        target: {
      ...
      fs.writeFileSync(absoluteFilePath, criticalHtml);
      console.log('inlined critical css for:', filePath);
    } catch (error) {
